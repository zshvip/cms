...
<div class="cl-sidebar" data-position="right" data-step="1" data-intro="<strong>Fixed Sidebar</strong> <br/> It adjust to your needs." >
    ...
    <div class="cl-navblock">
        <div class="menu-space">
            <div class="content">
                <div class="side-user">
                    <div class="avatar"><img src="<?php echo $this->url->get('images/avatar1_50.jpg'); ?>" alt="Avatar" /></div>
                    <div class="info">
                        <a href="#"><?php echo $this->session->get('user')->realname; ?></a>
                        <img src="<?php echo $this->url->get('images/state_online.png'); ?>" alt="Status" /> <span><?php echo $_t->_("common")['online']; ?></span>
                    </div>
                </div>
